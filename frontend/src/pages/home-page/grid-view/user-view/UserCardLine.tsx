...
const UserCardLine: React.FC<UserCardLineProps> = ({
  ...
  return (
    <button
      ...
      className={`
        w-full py-4 px-6 transition-all duration-300 ease-out group
        ...
        <div className="relative shrink-0">
          <div
            className={`w-14 h-14 rounded-full flex items-center justify-center 
              ...
              ${
                isDarkMode
                  ? "ring-slate-600 ring-offset-transparent group-hover:ring-blue-500/50"
                  : "ring-slate-200 ring-offset-transparent group-hover:ring-blue-400/50"
              }`}
