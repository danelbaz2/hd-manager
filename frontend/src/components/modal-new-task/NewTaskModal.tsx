  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        {/* Header */}
        <div
          className={`flex items-center justify-between px-6 md:px-8 py-4 md:py-5 border-b ${isDarkMode ? "border-slate-800/50" : "border-slate-200/50"
            }`}
        >
          <h2
        ...
        <DelayedLoader isLoading={isDataLoading} delay={200}>
          <div
            className={`px-6 lg:px-8 py-4 ${isDarkMode ? "dark-scrollbar" : "light-scrollbar"
              }`}
          >
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border-2 text-sm lg:text-base font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 ${isDarkMode
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className={`w-full px-4 py-3 rounded-xl border-2 resize-none text-sm lg:text-base transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 ${isDarkMode
                    ? "bg-slate-700/50 border-slate-600 text-white placeholder-slate-400 hover:border-slate-500 focus:border-blue-500"
                    : "bg-white border-slate-200 text-slate-800 placeholder-slate-400 hover:border-slate-300 focus:border-blue-500"
                    }`}
                />
        ...
        {/* Footer */}
        <div
          className={`flex items-center justify-end gap-10 px-6 lg:px-8 py-4 lg:py-5 border-t ${isDarkMode
        ...
        >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 lg:px-8 py-3 lg:py-3.5 rounded-xl text-white font-semibold text-sm lg:text-base transition-all duration-200 shadow-lg ${isSubmitting
