...
import { getStatusStyle } from "../../../pages/home-page/shared";
...
export const StatusChangeContent: React.FC<StatusChangeContentProps> = ({
  ...
  const getStatusLabel = (status: string): string => {
    return getStatusStyle(status as TaskStatus).label;
  };
  ...
  return (
    <div className="space-y-3">
      <p>
        ...
        <strong
          className={`inline-block max-w-[250px] truncate align-text-bottom ${
