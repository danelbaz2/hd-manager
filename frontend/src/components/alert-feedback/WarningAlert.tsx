...
const WarningAlert: React.FC<AlertProps> = ({
  id,
  title,
  message,
  onDismiss,
    ...
    >
      ...
      <div className="flex items-start gap-3 p-4 pt-5">
        ...
        <div
          ...
          `}
        >
          <AlertTriangle size={22} className="animate-warning-pulse" />
        </div>
      ...
      <div className="absolute -z-10 inset-0 opacity-20 blur-xl bg-amber-500" />
    </div>
  );
};
