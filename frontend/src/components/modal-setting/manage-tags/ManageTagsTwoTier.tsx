...
const ManageTagsTwoTier: React.FC = () => {
  ...
  const formColor =
    mode === "primary"
      ...
      : getPrimaryById(secondaryFormData.primaryTagId)?.color ||
        TAG_COLORS[0].bg;

  const isEditing =
    mode === "primary"
      ? editingPrimaryId !== null
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap items-center gap-4" dir="rtl">
            ...
            <button
              onClick={
                mode === "primary" ? handleSubmitPrimary : handleSubmitSecondary
              }
              disabled={isSaving}
              className={`
                ...
                {primaryTags.map((tag) => {
                  ...
                  return (
                    <TagCard
                      ...
                      onDeleteRequest={() =>
                        setDeleteTarget({ type: "primary", tag })
                      }
                    />
                  );
                })}
